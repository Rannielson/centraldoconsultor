/**
 * Cria o template "Relatório consolidado de boletos em abertos - Proseg" no OpenPDF.
 * Uso: node scripts/criar-template-consolidado.js
 *
...
const TEMPLATE = {
  id: 'relatorio-consolidado-proseg',
  name: 'Relatório consolidado de boletos em abertos - Proseg',
  paperSize: 'A4',
  orientation: 'landscape',
  columnsCount: 6,
  columnsDefinition: {
    '0': { label: 'Consultor', type: 'text' },
    '1': { label: 'Total geral', type: 'number' },
    '2': { label: 'Total aberto', type: 'number' },
    '3': { label: 'Total baixado', type: 'number' },
    '4': { label: '% abertos', type: 'text' },
    '5': { label: '% pagos', type: 'text' }
  }
};
